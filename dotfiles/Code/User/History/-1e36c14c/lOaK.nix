...

{
  ...
  home.file = {
    ".filebrowser.json".text = homeConfig.filebrowser;
    ".config/yt-dlp/config".text = homeConfig.yt-dlp;
    ".config/swappy/config".text = homeConfig.swappy;
    ".config/yazi".source = homeAssets.yazi;
