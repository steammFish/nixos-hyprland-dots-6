...

{
  ...
  home.file = {
    ...
    ".config/swappy/config".text = vars.homeConfig.swappy;
    ".config/yazi".source = vars.homeAssets.yazi;
    ".config/kitty/themes".source = vars.homeAssets.kitty_themes;
    # ".mybin".source = vars.homeAssets.mybin;
    # ".config/kitty/kitty.conf".text = vars.homeConfig.kitty;
